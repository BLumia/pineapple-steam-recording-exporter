...
Page {
    ...
    ColumnLayout {
        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                Label {
                    text: recordingManager && recordingManager.gameRecordingsPath ? 
                          qsTr("Scanning: %1").arg(recordingManager.gameRecordingsPath) :
                          qsTr("No recordings path configured")
                    font.pixelSize: 12
        ...
        StackLayout {
            ...
            currentIndex: {
                if (!recordingManager) return 2
                if (recordingManager.isScanning) return 0
                if (recordingManager.hasClips) return 1
                return 2
            }
    ...
    Component.onCompleted: {
        if (recordingManager && !recordingManager.hasClips) {
